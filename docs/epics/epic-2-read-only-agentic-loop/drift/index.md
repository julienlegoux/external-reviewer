...
* [The native half of the test command stopped working again](/epic-2-read-only-agentic-loop/drift/03-native-go-test-blocked-again.md) - issue 05, open, accepted-pending-triage
