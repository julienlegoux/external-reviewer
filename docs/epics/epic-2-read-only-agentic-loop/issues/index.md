...
* [Confine the run with --allow and os.OpenRoot](/epic-2-read-only-agentic-loop/issues/01-allow-list-and-root-confinement.md) - L, open, [#9](https://github.com/julienlegoux/external-reviewer/issues/9)
