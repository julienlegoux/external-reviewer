...
* [Epic 0: Skeleton hardening](/epic-0-skeleton-hardening/EPIC_0.md) - done, [#22](https://github.com/julienlegoux/external-reviewer/issues/22), milestone closed — remediation, ran before Epic 2 resumed
...
* [Epic 2: Read-only agentic loop](/epic-2-read-only-agentic-loop/EPIC_2.md) - open, [#2](https://github.com/julienlegoux/external-reviewer/issues/2)
