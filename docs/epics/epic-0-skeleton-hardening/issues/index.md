...
* [Read the task prompt under a context, a byte bound and real validation](./09-bounded-validated-prompt.md) - M, in-progress, [#31](https://github.com/julienlegoux/external-reviewer/issues/31)
