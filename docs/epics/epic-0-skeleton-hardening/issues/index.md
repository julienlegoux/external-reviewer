...
* [Read the task prompt under a context, a byte bound and real validation](./09-bounded-validated-prompt.md) - M, pr-open, [#31](https://github.com/julienlegoux/external-reviewer/issues/31), [PR #46](https://github.com/julienlegoux/external-reviewer/pull/46)
