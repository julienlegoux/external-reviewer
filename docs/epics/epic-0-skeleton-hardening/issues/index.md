...
* [Enforce gofmt in CI, normalise line endings, and lint on both OSes](./04-ci-formatting-gate.md) - S, in-progress, [#26](https://github.com/julienlegoux/external-reviewer/issues/26)
