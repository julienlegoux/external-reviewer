...
* [Handle the repository path as an OS path and emit wire paths on stderr](./08-os-and-wire-paths.md) - M, pr-open, [#30](https://github.com/julienlegoux/external-reviewer/issues/30), [PR #41](https://github.com/julienlegoux/external-reviewer/pull/41)
