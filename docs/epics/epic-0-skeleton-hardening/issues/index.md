...
* [Kill the four surviving mutants on the request side of the round trip](./06-request-side-mutants.md) - M, in-progress, [#28](https://github.com/julienlegoux/external-reviewer/issues/28)
