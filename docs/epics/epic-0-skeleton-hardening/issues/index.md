...
* [Kill the four surviving mutants on the request side of the round trip](./06-request-side-mutants.md) - M, done, [#28](https://github.com/julienlegoux/external-reviewer/issues/28), [PR #43](https://github.com/julienlegoux/external-reviewer/pull/43)
...
* [Read the task prompt under a context, a byte bound and real validation](./09-bounded-validated-prompt.md) - M, done, [#31](https://github.com/julienlegoux/external-reviewer/issues/31), [PR #46](https://github.com/julienlegoux/external-reviewer/pull/46)
* [Survive a failing or closed stdout without escaping the done-line seam](./10-stdout-write-failures.md) - M, done, [#32](https://github.com/julienlegoux/external-reviewer/issues/32), [PR #42](https://github.com/julienlegoux/external-reviewer/pull/42)
* [Bound the turn and fix its cost and cancellation precedence](./11-turn-hardening.md) - M, done, [#33](https://github.com/julienlegoux/external-reviewer/issues/33), [PR #45](https://github.com/julienlegoux/external-reviewer/pull/45)
* [Escape provider-controlled text on stderr and finish diag's polish](./12-diag-escaping-and-polish.md) - M, done, [#34](https://github.com/julienlegoux/external-reviewer/issues/34), [PR #44](https://github.com/julienlegoux/external-reviewer/pull/44)
