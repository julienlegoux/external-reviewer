...
* [Bound the turn and fix its cost and cancellation precedence](./11-turn-hardening.md) - M, in-progress, [#33](https://github.com/julienlegoux/external-reviewer/issues/33)
