...
* [Settle the done line's stop-reason vocabulary and document it in SPECS](./01-stop-reason-vocabulary.md) - S, pr-open, [#23](https://github.com/julienlegoux/external-reviewer/issues/23), [PR #37](https://github.com/julienlegoux/external-reviewer/pull/37)
...
* [Extract one importable faux harness and retire the mutable package-level seams](./05-shared-faux-harness.md) - M, pr-open, [#27](https://github.com/julienlegoux/external-reviewer/issues/27), [PR #40](https://github.com/julienlegoux/external-reviewer/pull/40)
