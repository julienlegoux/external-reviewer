...
* [Widen the write-API guard to every write operation CONVENTIONS names](./02-write-api-guard-coverage.md) - S, in-progress, [#24](https://github.com/julienlegoux/external-reviewer/issues/24)
