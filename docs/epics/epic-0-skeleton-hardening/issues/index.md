...
* [Kill the four surviving mutants on the request side of the round trip](./06-request-side-mutants.md) - M, pr-open, [#28](https://github.com/julienlegoux/external-reviewer/issues/28), [PR #43](https://github.com/julienlegoux/external-reviewer/pull/43)
