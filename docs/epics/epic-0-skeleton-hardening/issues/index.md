...
* [Survive a failing or closed stdout without escaping the done-line seam](./10-stdout-write-failures.md) - M, in-progress, [#32](https://github.com/julienlegoux/external-reviewer/issues/32)
