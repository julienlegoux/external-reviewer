...
* [Extract one importable faux harness and retire the mutable package-level seams](./05-shared-faux-harness.md) - M, in-progress, [#27](https://github.com/julienlegoux/external-reviewer/issues/27)
