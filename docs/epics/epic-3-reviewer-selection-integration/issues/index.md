...
* [Add the fail-closed model family classifier](/epic-3-reviewer-selection-integration/issues/02-model-family-classifier.md) - M, open, [#61](https://github.com/julienlegoux/external-reviewer/issues/61)
...
* [Resolve a tier to a reachable, allowed model](/epic-3-reviewer-selection-integration/issues/04-tier-resolution-chain.md) - M, open, [#63](https://github.com/julienlegoux/external-reviewer/issues/63)
* [Select the reviewer from the command line with --tier, --model and --exclude-family](/epic-3-reviewer-selection-integration/issues/05-review-tier-flags-and-exit-codes.md) - M, open, [#64](https://github.com/julienlegoux/external-reviewer/issues/64)
...
* [Set the loop caps from Epic 2's measurements](/epic-3-reviewer-selection-integration/issues/09-loop-caps-from-measurements.md) - M, open, [#68](https://github.com/julienlegoux/external-reviewer/issues/68)
