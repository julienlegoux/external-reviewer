...
* [Add the fail-closed model family classifier](/epic-3-reviewer-selection-integration/issues/02-model-family-classifier.md) - L, pr-open, [#61](https://github.com/julienlegoux/external-reviewer/issues/61), [PR #82](https://github.com/julienlegoux/external-reviewer/pull/82)
