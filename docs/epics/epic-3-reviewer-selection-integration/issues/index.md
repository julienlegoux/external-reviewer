...
* [Resolve a tier to a reachable, allowed model](/epic-3-reviewer-selection-integration/issues/04-tier-resolution-chain.md) - L, pr-open, [#63](https://github.com/julienlegoux/external-reviewer/issues/63), [PR #85](https://github.com/julienlegoux/external-reviewer/pull/85)
