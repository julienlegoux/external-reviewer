...
* [Set the loop caps from Epic 2's measurements](/epic-3-reviewer-selection-integration/issues/09-loop-caps-from-measurements.md) - S, pr-open, [#68](https://github.com/julienlegoux/external-reviewer/issues/68), [PR #83](https://github.com/julienlegoux/external-reviewer/pull/83)
