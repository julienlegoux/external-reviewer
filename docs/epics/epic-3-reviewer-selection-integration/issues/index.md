...
* [Make a path-scoped diff reachable through git_read](/epic-3-reviewer-selection-integration/issues/01-git-read-path-scoped-diff.md) - M, in-progress, [#60](https://github.com/julienlegoux/external-reviewer/issues/60)
