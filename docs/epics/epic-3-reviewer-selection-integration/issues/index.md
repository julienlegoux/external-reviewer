...
* [Accept the JSON request object on stdin, add --system and version](/epic-3-reviewer-selection-integration/issues/08-request-object-and-version.md) - M, in-progress, [#67](https://github.com/julienlegoux/external-reviewer/issues/67)
