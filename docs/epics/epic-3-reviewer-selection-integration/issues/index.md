...
* [Add the tiers command](/epic-3-reviewer-selection-integration/issues/06-tiers-command.md) - M, pr-open, [#65](https://github.com/julienlegoux/external-reviewer/issues/65), [PR #87](https://github.com/julienlegoux/external-reviewer/pull/87)
