...
* [Run a real review through the pipeline and record the success criteria](/epic-3-reviewer-selection-integration/issues/11-success-criteria-verification-run.md) - S, pr-open, [#69](https://github.com/julienlegoux/external-reviewer/issues/69), [PR #92](https://github.com/julienlegoux/external-reviewer/pull/92)
